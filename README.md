...
After this navigate to "Frontend" click the plus symbol and enter "Clockwork Card" into the search bar. Then click on the first result. ![Description](searchbar.png) and select "Install this repository in HACS" and you are done!
